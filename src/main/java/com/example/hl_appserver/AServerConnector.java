...
public class AServerConnector {
	...
	public void onMessage(final String message, final Session session) throws IOException {
		...
		if (receivedMessage.order.equals("1000")) {
			...
			aControllerContents.calculateScore(receivedMessage.messageContent.room_id,
					receivedMessage.messageContent.user_id, receivedMessage.messageContent.choice,
					receivedMessage.messageContent.pattern);
			...
			user_map.put(session, receivedMessage.messageContent.user_id);
			reverse_user_map.put(receivedMessage.messageContent.user_id, session);
			aControllerContents.enterRoom(receivedMessage.messageContent.room_id,
					receivedMessage.messageContent.user_id);
